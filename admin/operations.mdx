...
It deliberately does **not** duplicate pricing-watcher's MuAPI-catalog fetch — the two agents are
complementary, not competing: pricing-watcher owns cost drift, Model Monitor Agent owns quality
drift. Query recent runs:
