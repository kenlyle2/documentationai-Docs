...
The `/start` onboarding flow is designed so that a new user never touches a form from scratch. PostGlider does the research first, then shows you the results to confirm. The entire flow takes about 5 minutes.
